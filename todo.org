...
** TODO pick my initial categories
** DONE figure out how to schedule a task
** DONE get org-capture working
** DONE learn some key bindings for state transitions

** Move capture buffer tasks and archive to Dropbox

to reduce the friction from syncing these frequently changing files.
The tradeoff is I rely on dropbox syncing, ie, access to a network.
Seems like a reasonable tradeoff; I imagine that > 99% of my time I work connected.

so that is notes, and e-notes.

- notes: Dropbox/org/notes.org
- e-notes: Dropbox/entelo/org/e-notes.org

the next question is whether to move my todo.org and entelo.org into dropbox.
for the same friction reduction effect.

I think the answer is: yes.

- todo: Dropbox/org/todo.org
- entelo: Dropbox/entelo/org/entelo.org

** Q: NEXT vs TODO?

What is the effective difference between the NEXT and TODO states?

I guess that depends on your workflow.
Where is the example of the workflow diagram?
