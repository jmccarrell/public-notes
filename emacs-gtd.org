...
* Refine my use of GTD in emacs

** Map the [[file:GTD-book-notes.org::*Chapter%207:%20Organizing][7 main GTD data types]] onto a structure I can use
...
** Problems to Solve
1. I don't have any way to mark what is the next task up for projects; everything is in one flat list
2. No weekly review.  Not enough filtering, moving, coalescing of todos into projects.
3. I don't have enough separation between Someday and current projects
   - I imagine moving projects in/out of Someday as things gain/lose my attention
4. I have not applied my tags in a systematic fashion
5. My use of Dropbox to share context between emacs at home and work has failed with Sift's Dropbox policy
   - is this worth addressing?
6. I often conflate todo items and reference material; it is all in one kind of smushy bucket: todo.org and its archives.
7. I don't know enough about how John W organizes himself to inform what I do
   - Specifically:
     - Does he do weekly reviews?  What support in org does he use for this?
     - How does John map the 7 kinds of info onto org?
8. Figure out the syntax of the states, ie ="WAITING(w@/!)"= what do the =@/!= mean?

** Projects list
Right now I have projects and tasks in a single file: =todo.org=
